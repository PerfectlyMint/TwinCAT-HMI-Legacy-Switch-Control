...
module TcHmi {
    export module Controls {
        export module Legacy_Switch {
            export class Legacy_SwitchControl extends TcHmi.Controls.Beckhoff.TcHmiToggleButton {
                ...
                */
                public setSwitchFlavour(valueNew: string | undefined) {
        ...
        registerEx('Legacy_SwitchControl', 'TcHmi.Controls.Legacy_DipSwitch', Legacy_Switch.Legacy_SwitchControl);
    }
}